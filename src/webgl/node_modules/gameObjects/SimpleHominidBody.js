...
var decorateMeshWithBodyTemps = require('utils/decorateMeshWithBodyTemps');
...
function SimpleHominidBody(scene, camera, inputManager) {
	...
	Object.defineProperty(this, "world", {
		set: function(value) {
			if(world) {
				world.world.removeEventListener("postStep", this.onSimPostStep);
			}
			world = value;
			if(world) {
				world.world.addEventListener("postStep", this.onSimPostStep);
			}
		}
	});
...
function onPlayerBodyCollision(collision) {
	if(collision.target == this.body && collision.body.interactiveObject != null) {
		...
		if(interactiveObject.type == "tool") {
			this.world.remove(interactiveObject.object, function onRemoveCallback() {
				this.addTool(interactiveObject.object);
			});
		}
	}
}
