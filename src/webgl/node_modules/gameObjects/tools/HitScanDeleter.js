...
function HitScanDeleter(world, pos) {
	var geometry = new three.CylinderGeometry(0.065, 0.035, 1.5, 16, 1);
	var geometry2 = new three.CylinderGeometry(0.05, 0.1, 0.4, 12, 4);
	var position = new three.Vector3(0.05, 0, 0.0);
	...
	var material = new three.MeshPhongMaterial({
		map: new CheckerboardTexture(0x7f0000, 0xff7f7f)
	});
...
HitScanDeleter.prototype = Object.create(BaseGun.prototype);
...
function primaryFireShot() {
    ...
    with(result) {
	    if(hasHit) {
	    	this.world.makeHitEffect(hitPointWorld, this.player.playerSize * 0.3, 0.2);
	    	if(body.type == cannon.Body.DYNAMIC) {
	    		this.world.destroy(body.interactiveObject);
	    	}
	    }
	}
}
