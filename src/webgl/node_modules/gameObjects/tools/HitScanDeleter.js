...
function primaryFireShot() {
    ...
    with(result) {
	    if(hasHit) {
	    	this.player.world.makeHitEffect(hitPointWorld, this.player.playerSize * 0.3, 0.2);
	    	if(body.type == cannon.Body.DYNAMIC) {
	    		this.player.world.destroy(body.interactiveObject);
	    	}
	    }
	}
}
